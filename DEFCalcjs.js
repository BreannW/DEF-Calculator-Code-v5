...
{			  document.getElementById("NOT").innerHTML = 'Number of Trucks Requiring DEF:';
			...
			else
			{
			    ...
			    if (DEFUsedAnnually >= 0 && DEFUsedAnnually <= 600) {
	                ...
	                document.getElementById("TankP").innerHTML =
	                    "  We reccommend 330 Gallon Totes";
	                ...
	                document.getElementById("TankP").innerHTML =
	                    "  We recommend a 1,000 to 2,000 Gallon Mini Bulk Tank";
	                ...
	                document.getElementById("TankP").innerHTML =
	                    "We reccommend a 3,000 to 4,000 Gallon Mini Bulk Tank";
	                ...
	                document.getElementById("TankP").innerHTML =
	                    "We reccommend a 5,000 Gallon Bulk Tank";
	                // if its over 150,001 
	            } else {
	                document.getElementById("TankP").innerHTML =
	                    'We recommend you contact one of our  <a href="mailto:DEFSolutions@atlasoil.com">DEF Specialists</a> for proper sizing';
	            }
	        
	        if (document.getElementById('OTRradio').checked) {
	            document.getElementById("OTRText").innerHTML =
	                '<br>Send your OTR drivers with a bottle of DEF! <a href="mailto:DEFSolutions@atlasoil.com">Ask about our pre-packaged DEF goods today</a>!';
